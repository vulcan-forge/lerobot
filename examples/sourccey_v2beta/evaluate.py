...
policy = ACTPolicy.from_pretrained("outputs/train/act__sourccey_v2beta-001__tape-az__set000/checkpoints/020000/pretrained_model")
...
dataset = LeRobotDataset.create(
    repo_id="local/eval__sourccey_v2beta-001__tape-az__set000",
    fps=FPS,
