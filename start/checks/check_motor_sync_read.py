...
def test_feetech_motor_sync_read():
    ...
    try:
        ...
        try:
            ...
            right_arm_motors = ["right_arm_shoulder_pan", "right_arm_shoulder_lift", "right_arm_elbow_flex", "right_arm_wrist_flex", "right_arm_gripper"] # "right_arm_wrist_roll"] # "right_arm_gripper"]
