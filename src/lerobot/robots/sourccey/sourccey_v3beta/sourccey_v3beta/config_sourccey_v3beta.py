...
def sourccey_v3beta_cameras_config() -> dict[str, CameraConfig]:
    config = {
        ...
        "front_right": OpenCVCameraConfig(
            index_or_path="/dev/video2", fps=15, width=640, height=480
        ),
        "wrist_left": OpenCVCameraConfig(
            index_or_path="/dev/video4", fps=15, width=640, height=480
        ),
        "wrist_right": OpenCVCameraConfig(
            index_or_path="/dev/video6", fps=15, width=640, height=480
        ),
    }
    return config
