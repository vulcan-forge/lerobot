...
python -m lerobot.record \
    ...
    --teleop.left_port=/dev/ttyUSB1 \
    --teleop.right_port=/dev/ttyUSB3 \
    --dataset.repo_id=local/so100_double-001__towel-h__set001__mylesr \
...
torchrun --nproc_per_node=2 lerobot/scripts/train.py \
 --dataset.repo_id=local/so100_double-001__towel-4a-2b-4c-2d-3e__set000__combined \
 --policy.type=act \
 --policy.device=cuda \
 --output_dir=outputs/train/act__so100_double-001__towel-4a-2b-4c-2d-3e__set000__combined \
 --job_name=act__so100_double-001__towel-4a-2b-4c-2d-3e__set000__combined \
 --wandb.enable=false \
 --policy.push_to_hub=false \
 --steps=50000 \
 --batch_size=32 \
...
python -m lerobot.record  \
  ...
  --robot.right_port=/dev/ttyUSB2 \
  --robot.cameras="{ left: {type: opencv, index_or_path: 1, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 3, width: 640, height: 480, fps: 30}}" \
  --policy.path="outputs/train/act__so100_double-001__towel-4a-2b-4c-2d__set000__combined/checkpoints/last/pretrained_model" \
  --dataset.repo_id=local/eval__so100_double-001__towel-4a-2b-4c-2d__set004__combined \
...
python lerobot/scripts/combine_dataset.py \
    --repo_ids local/so100_double-001__towel-a__set000__mylesr local/so100_double-001__towel-a__set001__mylesr local/so100_double-001__towel-a__set002__mylesr local/so100_double-001__towel-a__set003__mylesr local/so100_double-001__towel-b__set000__mylesr local/so100_double-001__towel-b__set001__mylesr local/so100_double-001__towel-c__set000__mylesr local/so100_double-001__towel-c__set001__mylesr local/so100_double-001__towel-c__set002__mylesr local/so100_double-001__towel-c__set003__mylesr local/so100_double-001__towel-d__set000__mylesr local/so100_double-001__towel-d__set001__mylesr local/so100_double-001__towel-e__set000__mylesr local/so100_double-001__towel-e__set001__mylesr local/so100_double-001__towel-e__set002__mylesr \
    --output_repo_id=local/so100_double-001__towel-4a-2b-4c-2d-3e__set000__combined \
    --push_to_hub=0
