...
python -m lerobot.teleoperate \
    ...
    --robot.cameras="{ left: {type: opencv, index_or_path: 1, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 3, width: 640, height: 480, fps: 30}}" \
...
python -m lerobot.record \
    ...
    --teleop.left_port=/dev/ttyUSB1 \
    --teleop.right_port=/dev/ttyUSB3 \
    --dataset.repo_id=local/so100_double-001__towel-c__set001__mylesr \
...
python lerobot/scripts/train.py \
  --dataset.repo_id=local/so100_double-001__towel-2a-2b-2c__set000__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__so100_double-001__towel-2a-2b-2c__set000__combined \
  --job_name=act__so100_double-001__towel-2a-2b-2c__set000__combined \
  --policy.device=cuda \
  --wandb.enable=false \
...
CUDA_VISIBLE_DEVICES=1 python lerobot/scripts/train.py \
  --dataset.repo_id=local/eval__so100_double-001__towel-a-b-c__set000__combined \
  --policy.type=act \
  --output_dir=outputs/train/act__so100_double-001__towel-a-b-c__set000__combined \
  --job_name=act__so100_double-001__towel-a-b-c__set000__combined \
  --policy.device=cuda \
  --wandb.enable=false \
  --policy.push_to_hub=false \
  --steps=20000 
...
python -m lerobot.record  \
  ...
  --robot.right_port=/dev/ttyUSB2 \
  --robot.cameras="{ left: {type: opencv, index_or_path: 1, width: 640, height: 480, fps: 30}, right: {type: opencv, index_or_path: 3, width: 640, height: 480, fps: 30}}" \
  --policy.path="outputs/train/act__so100_double-001__towel-2a-2b__set000__combined/checkpoints/040000/pretrained_model" \
  --dataset.repo_id=local/eval__so100_double-001__towel-2a-2b__set001__combined \
...
python lerobot/scripts/combine_dataset.py \
    --repo_ids local/so100_double-001__towel-a__set000__mylesr local/so100_double-001__towel-a__set001__mylesr local/so100_double-001__towel-b__set000__mylesr local/so100_double-001__towel-b__set001__mylesr local/so100_double-001__towel-c__set000__mylesr local/so100_double-001__towel-c__set001__mylesr \
    --output_repo_id=local/so100_double-001__towel-2a-2b-2c__set000__combined \
    --push_to_hub=0
```
