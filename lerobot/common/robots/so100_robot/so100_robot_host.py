...
from .config_so100_robot import SO100RobotConfig, SO100RobotHostConfig
from .so100_robot import SO100Robot


class SO100RobotHost:
    def __init__(self, config: SO100RobotHostConfig):
...
def main():
    ...
    host_config = SO100RobotHostConfig()
    host = SO100RobotHost(host_config)
