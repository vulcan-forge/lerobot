...
```
python examples/sourccey_v2beta/teleoperate.py --display_data=true
```
...
```
python examples/sourccey_v2beta/replay.py --display_data=true
```

```
python examples/sourccey_v2beta/evaluate.py --display_data=true
```
