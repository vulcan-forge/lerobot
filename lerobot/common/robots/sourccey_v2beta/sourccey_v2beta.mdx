...
```
python -m examples.sourccey_v2beta.teleoperate --display_data=true
```

```
python -m examples.sourccey_v2beta.record --display_data=true
```

```
python -m examples.sourccey_v2beta.replay --display_data=true
```

```
python -m examples.sourccey_v2beta.evaluate --display_data=true
```
...
python lerobot/scripts/train.py \
  --dataset.repo_id=local/sourccey_v2beta_001_tape_c \
  --policy.type=act \
  --output_dir=outputs/train/act_sourccey_v2beta_001_tape_c \
  --job_name=act_sourccey_v2beta_001_tape_c \
  --policy.device=cuda \
  --wandb.enable=false \
  --steps=20000
```
