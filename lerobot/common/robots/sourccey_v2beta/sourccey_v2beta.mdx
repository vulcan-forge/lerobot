...
python lerobot/scripts/train.py \
  --dataset.repo_id=local/sourccey_v2beta-001__tape-az__set000 \
  --policy.type=act \
  --output_dir=outputs/train/act__sourccey_v2beta-001__tape-az__set000 \
  --job_name=act__sourccey_v2beta-001__tape-az__set000 \
  --policy.device=cuda \
  --wandb.enable=false \
  --steps=20000
```
