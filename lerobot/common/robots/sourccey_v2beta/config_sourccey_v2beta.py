...
def sourccey_v2beta_cameras_config() -> dict[str, CameraConfig]:
    config = {
        "front_left": OpenCVCameraConfig(
            index_or_path="/dev/video0", fps=5, width=640, height=480
        ),
        "front_right": OpenCVCameraConfig(
            index_or_path="/dev/video2", fps=5, width=640, height=480
        ),
        "wrist_left": OpenCVCameraConfig(
            index_or_path="/dev/video4", fps=5, width=640, height=480
        ),
        "wrist_right": OpenCVCameraConfig(
            index_or_path="/dev/video6", fps=5, width=640, height=480
        ),
    }
